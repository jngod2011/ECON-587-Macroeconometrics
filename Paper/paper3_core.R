...
write.csv(table[order(table[,1],decreasing = TRUE),],file="C:/Users/wang_/Desktop/3.csv")
##1996-2016
table <- matrix(rep(NA,1152),38,4)
rownames(table) <- a
colnames(table) <- c("Estimate", "Std. Error", "t value","Pr(>|t|)")
...
table[order(table[,1],decreasing = TRUE),]
write.csv(table[order(table[,1],decreasing = TRUE),],file="C:/Users/wang_/Desktop/4.csv")
